  ...
  <div class="container my-5">
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
      ...
      if (!$error) {
        ...
        <i class="bi bi-exclamation-circle-fill me-2"></i> Berhasil mengubah password!
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>';
      }
    }
    ?>
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
              ...
              <div class="text-left">
                <button type="button" class="btn btn-primary" onclick="window.location.href='profile.php'">Kembali</button>
              </div>
